...
- W7S core stores best-effort daily usage rollups in `DEPLOYMENTS_KV` and exposes them with effective soft limit warnings through `GET /api/v1/usage/<owner>/<repo>`.
